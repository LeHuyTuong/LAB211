...
public class Orders {
    ...
    public static boolean isDuplicate(String customerCode, ArrayList<Customer> customers) {
        for (Customer c : customers) {
            if (customerCode.equalsIgnoreCase(c.getCustomerCode())) {
                return true;
            }
        }
        return false;
    ...
    public static void placeAFeastOrder(ArrayList<Customer> customers, ArrayList<FeastMenu> menus, ArrayList<Order> orders, ArrayList<OrderDetails> order_menu) {
        ...
        while (check) {
            ...
            System.out.printf("Price            : %,d Vnd%n", (long) Double.parseDouble(selectedMenu.getPrice()));
            System.out.println("Ingredients:");
            System.out.println(selectedMenu.getIngredients().replaceAll("#", "\n").replaceAll("\"", ""));
            System.out.println(CUT_INFO);
            System.out.printf("Total cost       : %,d Vnd%n", (long) totalCost);
            System.out.println(CUT_INFO);
    ...
    public static void ordersUpdate(ArrayList<OrderDetails> order_menus, ArrayList<Order> orders, ArrayList<FeastMenu> menus) {
        ...
        while (true) {
            ...
            if (newMenuCode.isEmpty()) {
                System.out.println("Keep old data : " + orderToUpdate.getSetMenu());
                break;
            }
        ...
        while (true) {
            ...
            if (newTables.isEmpty()) {
                System.out.println("Keep old data : " + orderToUpdate.getNumberOfTables());
                break;
            }
        ...
        while (true) {
            ...
            if (newDateStr.isEmpty()) {
                System.out.println("Keep old data : " + orderToUpdate.getEventDate());
                break;
            }
